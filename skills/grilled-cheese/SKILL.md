...
1. **Start.** Run `grilled-cheese new`. It clears any previous session, opens the user's browser and prints the URL. If it errors, the server is not running — see below.
